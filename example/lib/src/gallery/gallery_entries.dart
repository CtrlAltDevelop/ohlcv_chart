...
List<GalleryEntry> _orderFlow() => [
      GalleryEntry(
        ...
        blurb: 'Time at price as TPO letters, with the point of control and '
            'the 70% value area.',
      ...
      GalleryEntry(
        id: 'footprint',
        title: 'Footprint',
        blurb: 'Bid against ask volume at every price, inside each candle, '
      ...
      GalleryEntry(
        ...
        blurb: 'Resting liquidity over time. A wall holds its price while the '
            'mid wanders past it.',
        group: GalleryGroup.orderFlow,
      ...
      GalleryEntry(
        ...
        blurb: 'Buying less selling, running through the session, with '
      ...
      GalleryEntry(
        id: 'liquidity-map',
        title: 'Liquidity map',
        blurb: 'Where the leveraged stops sit, and what a move that far would '
            'set off.',
        group: GalleryGroup.orderFlow,
      ...
      GalleryEntry(
        ...
        blurb: 'How much money is in the trade, and which side is paying to '
            'be there.',
        group: GalleryGroup.orderFlow,
      ...
      GalleryEntry(
        ...
        blurb: 'What a strategy makes at expiry, across every price, with the '
      ...
      GalleryEntry(
        ...
        blurb: 'Implied volatility by strike or by expiry — a smile, a skew '
            'or a term structure.',
        group: GalleryGroup.orderFlow,
      ...
      GalleryEntry(
        id: 'pair-spread',
        title: 'Pair spread',
        blurb: 'Two symbols read as one spread, with bands round its mean and '
...
List<GalleryEntry> _results() => [
      GalleryEntry(
        id: 'equity-curve',
        title: 'Equity curve',
        blurb: 'The curve, with an underwater panel under it showing how far '
      ...
      GalleryEntry(
        ...
        blurb: 'The same trades dealt in a thousand other orders, as '
      ...
      GalleryEntry(
        ...
        blurb: 'Trade results in R, with win rate, expectancy, profit factor '
            'and SQN over them.',
        group: GalleryGroup.results,
      ...
      GalleryEntry(
        ...
        blurb: 'Every trade from entry to exit, a lane per symbol, with how '
      ...
      GalleryEntry(
        id: 'seasonality',
        title: 'Seasonality',
        blurb: 'Results across the calendar: month by year, weekday by hour, '
      ...
      GalleryEntry(
        id: 'calendar',
        title: 'Calendar',
        blurb: 'Daily profit and loss on real month panels, each month '
      ...
      GalleryEntry(
        id: 'waterfall',
        title: 'Waterfall',
        blurb: 'A total built up step by step, from the opening balance to '
            'the closing one.',
        group: GalleryGroup.results,
...
List<GalleryEntry> _dashboard() => [
      GalleryEntry(
        id: 'treemap',
        title: 'Treemap',
        blurb: 'A rectangle split into tiles sized by value — a market map, '
      ...
      GalleryEntry(
        id: 'sunburst',
        title: 'Sunburst',
        blurb: 'The same hierarchy as a treemap, drawn as rings from the '
            'middle out.',
        group: GalleryGroup.dashboard,
      ...
      GalleryEntry(
        id: 'chord',
        title: 'Chord',
        blurb: 'Flow between nodes both ways round a ring — cycles drawn '
            'rather than broken.',
        group: GalleryGroup.dashboard,
        doc: 'chord-chart.md',
        variants: [
      ...
      GalleryEntry(
        id: 'marimekko',
        title: 'Marimekko',
        blurb: 'Two dimensions at once: every column as wide as it is big, '
      ...
      GalleryEntry(
        id: 'stream',
        title: 'Stream graph',
        blurb: 'A stack that flows: what a whole was made of, period by '
      ...
      GalleryEntry(
        ...
        blurb: 'Many things compared on many measures at once, an axis each, '
      ...
      GalleryEntry(
        ...
        blurb: 'How things moved between periods — by value, or by the ranks '
            'changing hands.',
        group: GalleryGroup.dashboard,
        doc: 'slope-chart.md',
        variants: [
      ...
      GalleryEntry(
        id: 'bubble',
        title: 'Bubble',
        blurb: 'Three numbers at once: two for position, one for the area of '
            'the bubble.',
        group: GalleryGroup.dashboard,
        doc: 'bubble-chart.md',
        variants: [
      ...
      GalleryEntry(
        ...
        variants: [
          ...
          GalleryVariant(
            ...
            build: () => HistogramChart(
              bins: histogramBins(
                galleryWave(600, base: 6000, swing: 3000, phase: 0.7)
                    .map((v) => v.abs())
                    .toList(),
                binCount: 20,
              ),
      ...
      GalleryEntry(
        ...
        blurb: 'The shape of a distribution, not just its quartiles — side by '
      ...
      GalleryEntry(
        id: 'bullet',
        title: 'Bullet',
        blurb: 'A measure against its target on a banded track — a gauge in '
            'the space of a line.',
        group: GalleryGroup.dashboard,
        doc: 'bullet-chart.md',
        variants: [
      ...
      GalleryEntry(
        id: 'waffle',
        title: 'Waffle',
        blurb: 'Shares as a hundred squares, counted rather than judged by '
            'angle.',
        group: GalleryGroup.dashboard,
        doc: 'waffle-chart.md',
        variants: [
      ...
      GalleryEntry(
        id: 'funnel',
        title: 'Funnel',
        blurb: 'Where the people go, stage by stage, tapered or '
            'straight-sided.',
        group: GalleryGroup.dashboard,
        doc: 'funnel-chart.md',
        variants: [
      ...
      GalleryEntry(
        ...
        blurb: 'Small multiples for a watchlist: a name, a shape and a number '
        ...
        variants: [
          GalleryVariant(
            ...
            build: () => SparklineGrid(
              ...
              subtitleStyle:
                  const TextStyle(color: Color(0xFF5C6570), fontSize: 9),
