...
String galleryPrice(double value) =>
      ...
      for (var i = 0; i < count; i++)
        LiquidityLevel(
          ...
          size: (i % 17 == 0 ? 900.0 : 120) +
              ...
              cos(i / 2.3).abs() * 90,
          side:
              62000 + i * 46 < 68000 ? LiquiditySide.long : LiquiditySide.short,
...
DateTime get galleryTimelineNow => DateTime(2026, 4, 6, 9).add(
      const Duration(hours: 50),
    );
...
List<double> galleryBand(double base, double phase, double drift,
        {int periods = 24}) =>
    [
